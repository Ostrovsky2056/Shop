			...
			<tr>
				<td width="25%">
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="signout">用戶退出</a>
							</td>
						</tr>
					</table></td>
				<td>
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td colspan="2">&nbsp;&nbsp;<input type="radio"
												name="gender" value="男" <% if("男".equals(gender)){out.print("checked=\"checked\"");} %> /> 男
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
												type="radio" name="gender" value="女"  <% if("女".equals(gender)){out.print("checked=\"checked\"");} %> /> 女</td>
										</tr>
										<tr>
